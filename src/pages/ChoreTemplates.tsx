      ...
      <div className="container mx-auto px-4 py-12 max-w-7xl">
          ...
          <div className="bg-gradient-to-r from-slate-50 to-cyan-50 p-6 rounded-xl border border-slate-200 hover:shadow-lg transition-all duration-300">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="font-semibold text-slate-800 text-lg">All Templates</p>
              </div>
            </div>
          </div>
          <div className="bg-gradient-to-r from-cyan-50 to-slate-50 p-6 rounded-xl border border-cyan-200 hover:shadow-lg transition-all duration-300">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="font-semibold text-slate-800 text-lg">Under 5 min</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {templates.map((template) => (
            <Card 
              key={template.id} 
              className="hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 overflow-hidden border-2 border-cyan-200 bg-white/80 backdrop-blur-sm group h-full flex flex-col"
            >
              <CardHeader className="bg-gradient-to-r from-cyan-50 to-slate-50 pb-4">
                ...
                <CardDescription className="text-slate-600 text-sm">{template.description}</CardDescription>
              </CardHeader>
              ...
              <CardContent className="p-0 flex-grow">
                ...
                <div className="p-4 space-y-4">
                  <div className="grid grid-cols-1 gap-3">
                    <div className="flex items-center justify-between text-sm">
                      <div className="flex items-center">
                        ...
                        <span className="text-slate-600">{getRecommendedAge(template.type)}</span>
                      </div>
                      <div className="flex items-center">
                        <Clock className="h-4 w-4 text-slate-500 mr-2" />
                        <span className="text-slate-600">{getEstimatedTime(template.type)}</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between text-sm bg-gradient-to-r from-slate-50 to-cyan-50 p-3 rounded-lg border border-slate-200">
                    <div className="flex items-center">
                      <span className="font-medium text-slate-700 mr-1">Chores:</span>
                      <span className="text-slate-600">{template.chores.length} included</span>
                    </div>
                    <div className="flex items-center">
                      <span className="font-medium text-slate-700 mr-1">Type:</span>
                      <span className="capitalize text-slate-600">{template.type}</span>
                    </div>
                  </div>
                </div>
              </CardContent>
        ...
        <div className="mt-16 bg-gradient-to-r from-cyan-50 to-slate-50 rounded-xl p-8 border border-cyan-200 max-w-5xl mx-auto shadow-lg">
          <h3 className="text-xl font-semibold text-slate-800 mb-3">Need Help Choosing?</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white p-5 rounded-lg border border-cyan-200 hover:shadow-md transition-shadow duration-300">
              <h4 className="font-medium text-cyan-700 mb-2 text-lg">Daily Chores</h4>
              <p className="text-slate-600">Perfect for younger children and building consistent habits</p>
            </div>
            <div className="bg-white p-5 rounded-lg border border-cyan-200 hover:shadow-md transition-shadow duration-300">
              <h4 className="font-medium text-cyan-700 mb-2 text-lg">Weekly Chores</h4>
              <p className="text-slate-600">Great for older kids and more substantial household tasks</p>
            </div>
            <div className="bg-white p-5 rounded-lg border border-cyan-200 hover:shadow-md transition-shadow duration-300">
              <h4 className="font-medium text-cyan-700 mb-2 text-lg">Custom Chores</h4>
              <p className="text-slate-600">Ideal when you have specific chores or unique family needs</p>
            </div>
          </div>
        </div>
      </div>
