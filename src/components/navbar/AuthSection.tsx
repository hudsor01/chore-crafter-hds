...
export const DesktopAuthSection = memo(({ user, signOut }: { user: any; signOut: () => void }) => (
...
export const MobileAuthSection = memo(({ user, signOut, onClose }: { user: any; signOut: () => void; onClose: () => void }) => {
  const handleSignOut = () => {
    signOut();
    onClose();
  };
